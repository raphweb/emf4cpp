...
if(EMF4CPP_IS_NOT_SUBPROJECT)
  ...
  add_library(${PROJECT_NAME}-ecore INTERFACE ${ecore_HEADERS} ${ecore_SOURCES})
  target_include_directories(${PROJECT_NAME}-ecore INTERFACE
          $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}>
          $<INSTALL_INTERFACE:include/emf4cpp>
      )
  ...
  if(EMF4CPP_USE_QT_5)
    set_target_properties(${PROJECT_NAME}-ecore PROPERTIES COMPILE_DEFINITIONS "EMF4CPP_USE_QT_5=1")
    target_link_libraries(${PROJECT_NAME}-ecore INTERFACE Qt5::Core)
  elseif(EMF4CPP_RESOURCE_API AND EMF4CPP_USE_CPPREST)
    set_target_properties(${PROJECT_NAME}-ecore PROPERTIES COMPILE_DEFINITIONS "EMF4CPP_USE_CPPREST=1")
    target_link_libraries(${PROJECT_NAME}-ecore INTERFACE cpprestsdk::cpprest)
  endif(EMF4CPP_USE_QT_5)
  target_link_libraries(${PROJECT_NAME}-ecore INTERFACE ${Boost_LIBRARIES})
